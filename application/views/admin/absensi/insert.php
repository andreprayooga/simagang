    ...
    <div class="row">
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action="<?php base_url('index.php/Admin/Absensi/insert') ?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label class="bmd-label-floating">Tanggal</label>
                <input type="date" id="input-tanggal" name="tanggal" class="form-control" value="<?php echo set_value("tanggal") ?>" autocomplete="off">
              </div>
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <div class="input-group clockpicker">
                      <input type="text" id="input-datang" name="datang" class="form-control" value="<?php echo set_value("datang") ?>" autocomplete="off">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <div class="input-group clockpicker">
                      <input type="text" id="input-pulang" name="pulang" class="form-control" value="<?php echo set_value("pulang") ?>" autocomplete="off">
                      <span class="input-group-addon">
                        <span class="glyphicon glyphicon-time"></span>
                      </span>
                    </div>
