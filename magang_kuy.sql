...
--
-- Host: localhost
-- Generation Time: Jan 21, 2019 at 10:14 AM
...
(1, 'zuzu', 'gunturtegar@gmail.com', 'woow');

-- --------------------------------------------------------

--
-- Table structure for table nama_instansi
--
...
--
-- Dumping data for table pendamping_magang
--
...
--
-- Table structure for table posisi_magang
--
...
Andre Prayogo, [21.01.19 21:12]
id_komentar int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table nama_instansi
--
ALTER TABLE nama_instansi
...
--
-- Constraints for table posisi_magang
--
ALTER TABLE posisi_magang
  ADD CONSTRAINT posisi_magang_ibfk_1 FOREIGN KEY (`fk_id_divisi`) REFERENCES divisi (`id_divisi`);

--
-- Constraints for table siswa_magang
--
ALTER TABLE siswa_magang
  ADD CONSTRAINT siswa_magang_ibfk_1 FOREIGN KEY (`fk_id_pendamping`) REFERENCES pendamping_magang (`id_pendamping`);
COMMIT;
